...
*Botanical descriptions*: All species in the plot were given a brief technical plant description summarized from the Flora of Virginia (@weakley_flora_2012) and the “Common Native Trees of Virginia” guide (Devoy et at, 2007). Ecological aspects were subtracted from various sources (@weakley_flora_2012, noauthor_missouri_nodate). Local habitat and species distribution refer to those within the plot.
