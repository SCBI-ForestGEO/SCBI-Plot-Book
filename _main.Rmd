...
files <- list.files(path = "T:/SIGEO/Pictures SIGEO Plants/Pictures Erika Gonzalez_2013/", pattern = "_cornus florida.jpg", full.names = TRUE)
![description](files)
```
...
<!--chapter:end:03-Woody-Plants.Rmd-->
