...
```{r}
setwd = "C:/Users/TerrellA3/Dropbox (Smithsonian)/GitHub_Alyssa/SCBI-Plot-Book/tables_for_chapter_3/"
library(knitr)
knitr::kable(
  head(saca_summary[, 1:2], 7), booktabs = TRUE,
  caption = 'Saca summary table'
)
```
