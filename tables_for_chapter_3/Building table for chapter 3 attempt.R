...
install.packages("fgeo", "dplyr", "tidyverse")
library(fgeo)
library(dplyr)
library(tidyverse)
...
for (sp in levels(scbi_all_alive$sp)) {
  ...
  write.table(x_long, file = file.path(paste0("C:/Users/TerrellA3/Dropbox (Smithsonian)/GitHub_Alyssa/SCBI-Plot-Book/tables_for_chapter_3/", sp,
            ".html")))
}
